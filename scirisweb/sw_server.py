...
def serve(html, ip='127.0.0.1', port=8888, n_retries=50):
    ...
    Args:
        html (str): HTML to serve
        ip (str, default = '127.0.0.1'): IP address at which the HTML will be served.
        port (int, default = 8888): the port at which to serve the HTML
        n_retries (int, default = 50): the number of nearby ports to search if the specified port is in use.
